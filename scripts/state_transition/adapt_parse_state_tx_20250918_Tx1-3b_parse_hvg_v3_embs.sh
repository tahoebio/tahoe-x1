...
CONFIG_FILE="/tahoe/drive_3/ANALYSIS/analysis_190/Code/state-tahoe-fork/scripts/train_state_tx/parse_pbmc_holdout/donor_tx13b_parse_hvg_v3.toml"
OUTPUT_DIR="/tahoe/drive_3/ANALYSIS/analysis_190/Code/train_state_tx/experiments"
EXPERIMENT_NAME="parse_state_adaptation_tx_$(date +%Y%m%d_%H%M%S)_Tx1-3B_parse_hvg_fewshot_v3_embs"
...
state tx train \
    ...
    data.kwargs.embed_key="tahoe_x1_3b" \
    ...
    model.kwargs.init_from=/tahoe/drive_3/ANALYSIS/analysis_190/Code/train_state_tx/experiments/tahoe_state_tx_20250821_045711_MFM3B_hvg_full/checkpoints/final.ckpt \
    model=tahoe_llama_212693232 \
    wandb.tags="[parse,fewshot,adaptation,donor,Tx1-3B]" \
