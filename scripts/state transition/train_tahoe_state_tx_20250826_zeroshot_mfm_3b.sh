...
CONFIG_FILE="${SCRIPT_DIR}/tahoe_5_holdout/zeroshot_generalization_converted_cell_lines_3b.toml"
...
state tx train \
    ...
    wandb.tags="[tahoe,zeroshot,drug_cell_split,mosaicfm_3b_merged]" \
