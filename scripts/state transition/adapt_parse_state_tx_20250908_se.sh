...
EXPERIMENT_NAME="parse_state_adaptation_tx_$(date +%Y%m%d_%H%M%S)_SE_hvg_full"
...
state tx train \
    ...
    model.kwargs.init_from=/tahoe/drive_3/ANALYSIS/analysis_190/Code/train_state_tx/experiments/tahoe_state_tx_20250812_165635_SE_hvg_full/checkpoints/final.ckpt \
    model=tahoe_llama_212693232 \
    wandb.tags="[parse,fewshot,adaptation,donor,SE]" \
